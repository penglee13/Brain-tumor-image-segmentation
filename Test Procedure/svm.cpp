...
private:
	...
	double kernel_rbf(int i, int j) const
	{
        ...
        //return exp(-gamma*(x[i],x[j]));
        //return 1/(exp((xi-xj-2)/1.38*(-2))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-10))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-15))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-5))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-7))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-9))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-4))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-6))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-5))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-4))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-3))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-2))-1);
        //return 1/(exp((xi-xj-2)/1.38*(-1))-1);
        //return 1/(exp((xi-xj-2)/1.38*(0))-1);
        //return 1/(exp((xi-xj-2)/1.38*(1))-1);
        //return 1/(exp((xi-xj-2)/1.38*(2))-1);
        //return 1/(exp((xi-xj-2)/1.38*(3))-1);
        //return 1/(exp((xi-xj-2)/1.38*(4))-1);
